...
# The Chart Objects 2
The chart service group's chart resource provides access to historical chart samples. We provide chart samples for a set number of horizons from 1 minute to 1 month. 
The amount of samples varies by instrument and asset class with some Forex data dating back as along as 2002.
The chart object holds a number of different information related to historical prices.
